...
def domain_list():
    return ["d13579.com", "osmtv.cn", "kingbaly.com", "animater.cn", "xdl5566.com", "xindeli015.com", "bzj55.com",
            "f13579.com", "a1628.net", "deli2828.com", "xindeli099.com", "xindeli789.com", "xindeli168.com"]
...
#    db_conn.execute("DROP TABLE IF EXISTS {0}".format(db_table))
    try:
        db_conn.execute("CREATE TABLE {}(name_id INTEGER PRIMARY KEY, {} TEXT, {} TEXT, {} TEXT, {} TEXT)".format(db_table, db_column1, db_column2, db_column3, db_column4))
        db_conn.commit()
